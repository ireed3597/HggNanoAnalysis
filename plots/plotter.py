...
class Plotter:
    ...
    def preprocess(self):
        ...
        self.process_id_map = {}
        for sample, info in self.input_options.items():
            if self.debug:
        ...
        for idx, branch in enumerate(self.branches):
            ...
            if "signal" in self.histograms[branch]:
                if (
                    ...
                    signal_label = "signal x {:0.0f}".format(
                        self.plot_options[branch]["signal_scaling"]
                    )
                else:
                    signal_label = "signal"
...
if __name__ == "__main__":
    ...
    #table_test = Plotter(
    #    df="../output/HHggTauTau_InclusivePresel_1tau0lep_02Aug2021.pkl",
    #    plot_options="table.json",
    #    branches=["lead_pho_ptmgg"],
    #    debug=True,
    #)
