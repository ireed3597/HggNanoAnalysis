...
#define NELECTRON_MAX 210 // for Electron_* collection
...
namespace tas {
    ...
    const float &fixedGridRhoAll(); // rho from neutral PF Candidates with |eta| < 2.5, used e.g. for rho corrections of some lepton isolations
