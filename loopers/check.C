...
int ScanChain( TChain *ch, string proc, int year, float scale_factor = 1, bool resonant = false ) {
	...
	TString file_name = proc + "_17Jan2022_check_" +  std::to_string(year);
	...
	//non-SM couplings
	else if (proc.find(std::string("ggf_c0_HHggtautau")) != std::string::npos) 				process_id = -10;
	else if (proc.find(std::string("ggf_c1_HHggtautau")) != std::string::npos) 				process_id = -11;
	else if (proc.find(std::string("ggf_c2p45_HHggtautau")) != std::string::npos) 				process_id = -12;
	else if (proc.find(std::string("ggf_c5_HHggtautau")) != std::string::npos) 				process_id = -13;
        ...
        for( unsigned int loop_event = 0; loop_event < tree->GetEntriesFast(); ++loop_event) {
         ...
         bar.progress(nEventsTotal, nEventsChain);
			...
			if ( cat1 ){
				...
				lep2_id_vs_e	=	Tau_idDeepTau2017v2p1VSe()[h_cand1[0]];	
				lep2_id_vs_m	=	Tau_idDeepTau2017v2p1VSmu()[h_cand1[0]];	
				lep2_id_vs_jet	=	Tau_idDeepTau2017v2p1VSjet()[h_cand1[0]];
			...
			if ( cat3 ){
				...
				lep1_id_vs_e	=	Tau_idDeepTau2017v2p1VSe()[h_cand1[0]];	
				lep1_id_vs_m	=	Tau_idDeepTau2017v2p1VSmu()[h_cand1[0]];	
				...
				lep2_pdgID		=	15 * sgn( lep2_charge );
				lep2_id_vs_e	=	Tau_idDeepTau2017v2p1VSe()[h_cand2[0]];	
				lep2_id_vs_m	=	Tau_idDeepTau2017v2p1VSmu()[h_cand2[0]];	
				lep2_id_vs_jet	=	Tau_idDeepTau2017v2p1VSjet()[h_cand2[0]];
			...
			if ( category < 8 ){
				...
				m_tautauSVFitLoose					= rndgen.Gaus(125,10);
